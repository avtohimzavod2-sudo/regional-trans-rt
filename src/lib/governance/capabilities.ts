...
export interface RtCapability {
  ...
  /** Where this escalates TODAY. Must be a node that actually exists — an
   * escalation path to an unbuilt manager is not a path. */
  escalationTarget: string;
  /** Where it will escalate once the intended manager layer is built. */
  plannedEscalationTarget?: string;
...
export const RT_ACCOUNTABILITY_MATRIX: RtCapability[] = [
  // ---- Communication -----------------------------------------------------
  {
    ...
    plannedEscalationTarget: "AKZHOL",
  ...
  },
  {
    ...
    plannedEscalationTarget: "HUMAN_RELIABILITY_OWNER",
    humanApprovalRequired: false,
    preLiveRequired: true,
  ...
  // ---- Delivery / cargo --------------------------------------------------
  {
    ...
    escalationTarget: "ARTUR",
    plannedEscalationTarget: "ZHOLAMAN",
    humanApprovalRequired: false,
    preLiveRequired: false,
